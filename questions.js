(function (root, factory) {
  ...
  const dimensions = {
    role: { label: "公共角色", left: "公共保障", right: "市場自治", leftCode: "S", rightCode: "L" },
  ...
  const questions = [
    { id: "R01", dimension: "role", topic: "社會安全", direction: 1, text: "即使需要增加公共支出，政府仍應保障每個人的基本醫療與長期照護。" },
    { id: "R02", dimension: "role", topic: "產業政策", direction: -1, text: "只要沒有壟斷或欺詐，政府應盡量少介入企業的定價與經營。" },
    { id: "R03", dimension: "role", topic: "住宅", direction: 1, text: "當租屋市場無法提供可負擔住宅時，政府應直接興建或大量供給社會住宅。" },
    { id: "R04", dimension: "role", topic: "教育", direction: -1, text: "教育服務應讓家庭保有更多自費選擇，而非主要由政府統一提供。" },
    { id: "R05", dimension: "role", topic: "勞動", direction: 1, text: "政府應設定基本工資與勞動條件，即使這會增加部分企業成本。" },
    { id: "R06", dimension: "role", topic: "退休", direction: -1, text: "退休生活主要應由個人儲蓄與民間保險負責，而不是擴大公共年金。" },
    { id: "R07", dimension: "role", topic: "氣候", direction: 1, text: "為降低碳排，政府可以用稅制與管制要求企業承擔轉型成本。" },
    { id: "R08", dimension: "role", topic: "數位治理", direction: -1, text: "新科技應先自由發展，除非已造成明確傷害，政府才需要管制。" },
  ...
  return { version: "2.0.0", dimensions, questions };
});
